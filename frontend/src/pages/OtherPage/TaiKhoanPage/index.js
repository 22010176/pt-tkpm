  ...
  return (
    <Page1 sidebar={<SideNavbar />}>
      <div className='d-flex p-3 gap-3 flex-column w-100 h-100 _bg-blue-0'>
        <h2 className='_bg-blue w-auto p-2 mx-auto text-center text-light px-5 rounded-3 shadow-sm'>
          Tài khoản
        </h2>

        <div class="d-flex gap-0 gap-3 h-100">
          ...
          <ContentA as={Form} className="d-flex flex-column justify-content-between flex-grow-1 gap-4 p-5 w-75 h-100">
            <FormGroup className='d-flex flex-column gap-xl-3'>
              ...
              <FormGroup className='d-flex w-100 flex-wrap gap-2'>
                <FormLabel className='fw-bold w-100 fs-5'>Địa chỉ</FormLabel>
