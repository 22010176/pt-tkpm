...
SELECT qh.ma, cn.ma AS maChucNang, cn.ten AS tenChucNang, hd.ma AS maHanhDong, hd.ten AS tenHanhDong FROM quyenHan AS qh
...
function authPermission({ chucNangID = 0, hanhDongID = 0, last = false }) {
  return async function (req, res, next) {
    if (res.locals.permissionCheck) return next()
